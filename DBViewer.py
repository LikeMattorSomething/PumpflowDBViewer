...
with pyodbc.connect('DRIVER='+driver+';SERVER=tcp:'+server+';PORT=1433;DATABASE='+database+';UID='+username+';PWD='+ password) as conn:
    with conn.cursor() as cursor:
        ...
        def SQLSearch_JobAndTest():
            ...
            SelectTable = st.checkbox("Select a table to display",("MainTable","JobInfo","AddTemperatures","AddAuxPressure","AddAuxFlow","Value_Description"))
        ...
        def SQLSearch_Date():
            ...
            SelectTable = st.checkbox("Select a table to display",("MainTable","AddTemperatures","AddAuxPressure","AddAuxFlow"))
